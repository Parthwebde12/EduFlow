...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const data = await register(form.name, form.email, form.password, form.college);
    ...
    <div className="min-h-screen bg-linear-to-br from-slate-50 via-blue-50 to-purple-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-900 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-1 text-sm">Start your productivity journey</p>
        </div>
